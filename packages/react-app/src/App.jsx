...
// const moralisProvider = new ethers.providers.StaticJsonRpcProvider(
//   "https://eth-mainnet.alchemyapi.io/v2/0XM09Z2Uk9vw5C18PjW_dXWE48BAv46c",
// );
// const poktMainnetProvider = new ethers.providers.StaticJsonRpcProvider(
//   "https://eth-mainnet.gateway.pokt.network/v1/lb/611156b4a585a20035148406",
// );
const mainnetAlchemyProvider = new ethers.providers.StaticJsonRpcProvider(
  "https://eth-mainnet.alchemyapi.io/v2/0XM09Z2Uk9vw5C18PjW_dXWE48BAv46c",
);
    ...
    walletconnect: {
      ...
      options: {
        ...
        rpc: {
          ...
          1: `https://eth-mainnet.alchemyapi.io/v2/0XM09Z2Uk9vw5C18PjW_dXWE48BAv46c`, // mainnet // For more WalletConnect providers: https://docs.walletconnect.org/quick-start/dapps/web3-provider#required
...
function App(props) {
  const mainnetProvider = mainnetAlchemyProvider;
  ...
  */
  ...
  if (NETWORKCHECK && localChainId && selectedChainId && localChainId !== selectedChainId) {
    ...
    networkDisplay = <div className="text-yellow-500">{targetNetwork.name}</div>;
  }
